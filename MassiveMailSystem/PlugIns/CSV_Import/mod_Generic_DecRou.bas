...
Private Type strct_DLLParams
    ...
    XCSV_AddFieldsBarCode   As Boolean
    XCSV_AddFieldsPSTL      As Boolean
    XCSV_DSN                As String
    XCSV_FileName           As String
    XCSV_IdDataCutter       As Integer
    XCSV_SubDivideChar      As String
    XCSV_TableName          As String
    XCSV_TNS                As String
End Type
