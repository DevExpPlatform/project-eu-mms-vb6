...
Private Type strct_DLLParams
    XSQL_AddFieldsBarCode   As Boolean
    XSQL_AddFieldsPSTL      As Boolean
    XSQL_DSN                As String
    XSQL_FileName           As String
    XSQL_IdDataCutter       As Integer
    XSQL_SubDivideChar      As String
    XSQL_TableName          As String
    XSQL_TNS                As String
End Type
